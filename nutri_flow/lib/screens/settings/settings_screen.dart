...
/// Lets the dietitian set their clinic name + logo once — both then appear
/// on every exported PDF's cover page.
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: profileAsync.when(
        ...
        data: (_) => PageBody.form(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.stretch,
            children: [
              Text(
                'الشعار والاسم يظهران في صفحة غلاف كل خطة PDF تُصدَّر من التطبيق',
                style: Theme.of(
                  context,
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  labelText: 'اسم الأخصائي/ة أو العيادة',
